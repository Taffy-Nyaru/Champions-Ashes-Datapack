...
execute as a346a606-7102-4c7f-b48d-14038f3a5e56 on origin if entity @s[predicate=ldmc:using_item/sonic_boom_shard] run function ldmc:items/sonic_boom_shard/sonic_boom
execute as @s[advancements={ldmc:hurt_entities=true}] at @s if entity @e[tag=raycast.target,limit=1,type=!#ldmc:special_entities,distance=..10] run function ldmc:items/sonic_boom_shard/sonic_boom
...
execute as @a if score @s shift matches 0 as 2094fd65-93de-4a69-9ea2-a74c7f35bc75 on origin if entity @s[predicate=ldmc:using_item/sonic_boom_shard] at @s run function ldmc:items/sonic_boom_shard/tp
execute as @a if score @s shift matches 1.. as 2094fd65-93de-4a69-9ea2-a74c7f35bc75 on origin if entity @s[predicate=ldmc:using_item/sonic_boom_shard] at @s run function ldmc:items/sonic_boom_shard/callback
