...
execute as 2094fd65-93de-4a69-9ea2-a74c7f35bc75 on origin if entity @s[nbt={Inventory:[{Slot:-106b,tag:{id:"ldmc:eternal_crystal"}}]}] run effect give @s invisibility 1 0 true
execute as 2094fd65-93de-4a69-9ea2-a74c7f35bc75 on origin if entity @s[nbt={Inventory:[{Slot:-106b,tag:{id:"ldmc:eternal_crystal"}}]}] run effect give @s resistance 1 255 true
execute as 2094fd65-93de-4a69-9ea2-a74c7f35bc75 on origin if entity @s[nbt={Inventory:[{Slot:-106b,tag:{id:"ldmc:eternal_crystal"}}]}] run tag @s add crystal_tp_tick
