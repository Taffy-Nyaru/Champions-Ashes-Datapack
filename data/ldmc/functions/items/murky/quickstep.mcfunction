...
execute as @s[tag=murky_tp] positioned ^ ^ ^ run teleport @s 495e8517-93df-413a-9f58-5fe66e5b0a82
...
execute if score @s quickstep_delay matches 10.. if block ~ ~-1 ~ air run tp @s ~ ~-2 ~
execute if score @s quickstep_delay matches 10.. if block ~ ~-1 ~ air run tp 495e8517-93df-413a-9f58-5fe66e5b0a82 ~ ~ ~
