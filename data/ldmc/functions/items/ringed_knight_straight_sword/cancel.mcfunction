...
execute if score @s cancel matches 1.. run item modify entity @s weapon.mainhand ldmc:rkss_ignite
...
execute if score @s cancel matches 10.. run item modify entity @s weapon.mainhand ldmc:rkss
