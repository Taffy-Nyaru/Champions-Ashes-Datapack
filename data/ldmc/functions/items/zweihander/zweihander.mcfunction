...
execute as a346a606-7102-4c7f-b48d-14038f3a5e56 on origin if entity @s[predicate=ldmc:using_item/zweihander] at @s as @e[distance=..8,limit=1,type=!#ldmc:special_entities,tag=raycast.target,type=!player] run damage @s 25 player_attack by @a[predicate=ldmc:using_item/zweihander,limit=1,sort=nearest]
execute if entity @s[advancements={ldmc:hurt_entities=true}] at @s as @e[distance=..8,limit=1,type=!#ldmc:special_entities,tag=raycast.target,type=!player] run damage @s 25 player_attack by @a[predicate=ldmc:using_item/zweihander,limit=1,sort=nearest]
