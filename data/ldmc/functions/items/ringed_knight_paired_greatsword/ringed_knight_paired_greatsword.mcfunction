...
execute as 2094fd65-93de-4a69-9ea2-a74c7f35bc75 on origin if entity @s[predicate=ldmc:using_item/ringed_knight_paired_greatsword] at @s unless entity @e[tag=aj.rkgugs_skill.root,distance=..2] run function ldmc:items/ringed_knight_paired_greatsword/skill
