...
execute at @e[tag=golem_arrow] if entity @e[tag=!golem_arrow,tag=!loop_start,distance=..1] run summon creeper ~ ~ ~ {Fuse:0,ExplosionRadius:1,Invulnerable:1b,Tags:["690bomber"]}
