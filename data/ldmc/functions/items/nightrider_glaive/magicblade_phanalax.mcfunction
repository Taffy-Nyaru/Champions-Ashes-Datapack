...
execute as 2094fd65-93de-4a69-9ea2-a74c7f35bc75 on origin if entity @s[nbt={SelectedItem:{tag:{id:"ldmc:night_cavalry_halberd"}}}] run scoreboard players add @s glaive_damage 100
execute store result storage generic:main nightrider_glaive_damage int 1 run scoreboard players get @s glaive_damage
execute as 2094fd65-93de-4a69-9ea2-a74c7f35bc75 on origin if entity @s[nbt={SelectedItem:{tag:{id:"ldmc:night_cavalry_halberd"}}}] run item modify entity @s[gamemode=survival] weapon.mainhand ldmc:nightrider_glaive
