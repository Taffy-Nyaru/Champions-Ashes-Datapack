...
execute as 2094fd65-93de-4a69-9ea2-a74c7f35bc75 on origin if entity @s[predicate=ldmc:using_item/nightrider_glaive] at @s unless entity @e[tag=phanalax0,distance=..4] unless entity @e[tag=phanalax1,distance=..4] unless entity @e[tag=phanalax2,distance=..4] run function ldmc:projectiles/phanalax/summon_phanalax
execute as 2094fd65-93de-4a69-9ea2-a74c7f35bc75 on origin if entity @s[predicate=ldmc:using_item/nightrider_glaive] run scoreboard players add @s glaive_damage 100
execute store result storage generic:main nightrider_glaive_damage int 1 run scoreboard players get @s glaive_damage
execute as 2094fd65-93de-4a69-9ea2-a74c7f35bc75 on origin if entity @s[predicate=ldmc:using_item/nightrider_glaive] run item modify entity @s[gamemode=survival] weapon.mainhand ldmc:nightrider_glaive
