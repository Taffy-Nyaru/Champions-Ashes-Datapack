...
execute if score @s skill_time matches 1..24 as @e[type=!#ldmc:special_entities,distance=..5,tag=!using_skill] run damage @s 1 ldmc:frostbite by @a[limit=1,sort=nearest,tag=using_skill]
