summon item_display ^ ^0.2 ^0.5 {item:{Count:1b,id:"minecraft:warped_fungus_on_a_stick",tag:{Enchantments:[{id:"infinity",lvl:1}],CustomModelData:1390091}},Tags:["moonlight_slash"],brightness:{sky:15}}
...
tag @s add moonlight
execute as @s[gamemode=survival] run function ldmc:items/item_durability