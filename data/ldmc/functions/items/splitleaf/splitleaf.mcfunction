...
execute if entity @s[advancements={ldmc:hurt_entities=true}] at @s as @e[distance=..5,limit=1,type=!#ldmc:special_entities,tag=raycast.target] run damage @s 15 minecraft:player_attack by @a[limit=1,sort=nearest,nbt={SelectedItem:{tag:{id:"ldmc:splitleaf"}}}]
