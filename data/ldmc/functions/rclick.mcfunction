...
execute as @e[tag=block_clicker] store result score @s block_rClick run data get entity @s interaction.timestamp
execute as @e[tag=block_clicker] store result score @s block_lClick run data get entity @s attack.timestamp
execute as @e[tag=block_clicker,scores={block_rClick=1..}] run data modify entity @s interaction.timestamp set value 0
#execute as @e[tag=block_clicker] run data modify entity @s attack.timestamp set value 0
execute as @e[tag=block_clicker,scores={block_lClick=1..}] run data modify entity @s attack.timestamp set value 0
