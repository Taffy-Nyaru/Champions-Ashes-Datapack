...
execute as @e[tag=pearl] at @s unless block ~ ~ ~ #ldmc:transparent_blocks run function ldmc:entities/search_air
execute as @e[tag=night_cavalry] at @s unless block ~ ~ ~ #ldmc:transparent_blocks run function ldmc:entities/search_air
