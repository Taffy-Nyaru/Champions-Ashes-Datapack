summon wither_skeleton ~ ~ ~ {CustomName:'[{"translate":"entity.ldmc.drakeblood_knight","italic":false}]',Health:250,DeathLootTable:"ldmc:entities/drakeblood_knights",CanPickUpLoot:1b,PersistenceRequired:1b,Tags:["drakeblood_knight"],ActiveEffects:[{Id:10,Duration:-1,Amplifier:1,ShowParticles:0b}],Attributes:[{Name:"generic.attack_damage",Base:12f},{Name:"generic.follow_range",Base:2048f},{Name:"generic.knockback_resistance",Base:1f},{Name:"generic.max_health",Base:250f}]}
