summon wither_skeleton ~ ~ ~ {CustomName:'[{"translate":"entity.ldmc.drakeblood_knight","italic":false}]',Health:550,CanPickUpLoot:1b,PersistenceRequired:1b,Tags:["drakeblood_knight"],ActiveEffects:[{Id:11,Duration:-1,Amplifier:1,ShowParticles:0b},{Id:22,Duration:-1,Amplifier:1,ShowParticles:0b},{Id:16,Duration:-1,Amplifier:1,ShowParticles:0b},{Id:10,Duration:-1,Amplifier:1,ShowParticles:0b}],Attributes:[{Name:"generic.attack_damage",Base:12f},{Name:"generic.follow_range",Base:2048f},{Name:"generic.knockback_resistance",Base:1f},{Name:"generic.movement_speed",Base:0.4f},{Name:"generic.max_health",Base:550f}]}
