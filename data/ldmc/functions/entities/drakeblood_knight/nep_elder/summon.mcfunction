summon wither_skeleton ~ ~ ~ {CustomName:'[{"translate":"entity.ldmc.nep_elder","italic":false}]',Health:256,DeathLootTable:"ldmc:entities/nep_elder",CanPickUpLoot:1b,PersistenceRequired:1b,Tags:["nep_elder","drakeblood_knight"],ActiveEffects:[{Id:10,Duration:-1,Amplifier:0,ShowParticles:0b}],Attributes:[{Name:"generic.attack_damage",Base:13f},{Name:"generic.follow_range",Base:2048f},{Name:"generic.knockback_resistance",Base:1f},{Name:"generic.max_health",Base:256f}]}
