...
execute if entity @e[type=snowball,predicate=ldmc:misc/shadow_vortex] as 942429eb-9233-4105-a36e-8fec8f4ce862 on origin run tag @s[tag=!used_vortex] add used_vortex
execute if entity @e[type=snowball,predicate=ldmc:misc/thunder_knife] as 942429eb-9233-4105-a36e-8fec8f4ce862 on origin run tag @s[tag=!killer] add killer
execute if entity @e[type=snowball,predicate=ldmc:misc/stalk_dung_pie] as 942429eb-9233-4105-a36e-8fec8f4ce862 on origin run tag @s[tag=!csg] add csg