...
tag @e[limit=1,sort=nearest,type=!#ldmc:special_entities,tag=!lazer_owner,tag=!lazer_node,tag=!lazer_target,distance=..20] add lazer_target
tag @e[limit=1,sort=nearest,type=!#ldmc:special_entities,tag=!lazer_owner,tag=!lazer_node,tag=!end_entity,distance=..20] add end_entity
