...
execute store result storage generic:main vortex_scale[1] float 0.001 run scoreboard players get @s vortex_scale
execute store result storage generic:main vortex_scale[2] float 0.005 run scoreboard players get @s vortex_scale
