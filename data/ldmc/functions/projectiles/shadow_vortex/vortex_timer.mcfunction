...
execute if score @s vortex_timer matches 1.. at @s run function ldmc:projectiles/shadow_vortex/vortex_function
...
function ldmc:projectiles/shadow_vortex/rotation