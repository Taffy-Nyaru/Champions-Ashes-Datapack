#scoreboard players operation #player_count ldmcValue = now_player_count player_count
#execute if score #player_count ldmcValue matches 1.. run scoreboard players remove #player_count ldmcValue 1
#execute if score #player_count ldmcValue matches 1.. run function ldmc:summon_interaction
