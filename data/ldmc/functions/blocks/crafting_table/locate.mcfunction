...
execute if score #custom_model_data ldmcValue matches 1440009 at @s anchored eyes positioned ^ ^ ^ run function ldmc:blocks/crafting_table/ray
...
execute if score #left_custom_model_data ldmcValue matches 1440009 at @s anchored eyes positioned ^ ^ ^ run function ldmc:blocks/crafting_table/ray
