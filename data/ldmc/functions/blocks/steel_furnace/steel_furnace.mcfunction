title @a[scores={usedFurnace=1..},limit=1,sort=nearest,distance=..5] actionbar "You need to hold iron ingots and close enough to the furnace to use it."
...
scoreboard players operation #final_refine_time ldmc_Timer *= @s steelCount
