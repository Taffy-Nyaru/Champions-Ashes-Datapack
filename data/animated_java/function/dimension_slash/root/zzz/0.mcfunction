...
function animated_java:dimension_slash/root/outdated_tellraw with storage aj:temp
data modify entity @s data.rigHash set value '17e38e9630139efee50b086fd59118e9abe64690872361d451c22cbe17a7748a'
