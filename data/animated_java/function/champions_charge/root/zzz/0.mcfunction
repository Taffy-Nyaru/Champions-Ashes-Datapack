...
function animated_java:champions_charge/root/outdated_tellraw with storage aj:temp
data modify entity @s data.rigHash set value 'b2265d9dfff9fbd574f162deed48a0d2bd7c897f931a8a62beca1e26c67cea37'
