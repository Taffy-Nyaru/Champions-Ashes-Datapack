...
function animated_java:blade_of_peril/root/outdated_tellraw with storage aj:temp
data modify entity @s data.rigHash set value 'b4738e446f51a509b95513bdec3a20705a2c062fe28226399ca23b06e081fd80'
