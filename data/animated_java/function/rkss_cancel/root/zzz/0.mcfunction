...
function animated_java:rkss_cancel/root/outdated_tellraw with storage aj:temp
data modify entity @s data.rigHash set value '6a3289c8589da10a34e561b1945ce1939a43a3f18f56f5d0f05fc58669a9e985'
