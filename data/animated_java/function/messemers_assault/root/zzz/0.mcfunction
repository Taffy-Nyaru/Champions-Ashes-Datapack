...
function animated_java:messemers_assault/root/outdated_tellraw with storage aj:temp
data modify entity @s data.rigHash set value '22e6b1d6ee3babb138aa21febca105fa91ad9647772442e279d7a5d8fa299bee'
