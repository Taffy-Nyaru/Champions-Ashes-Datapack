...
function animated_java:steel_caller/root/outdated_tellraw with storage aj:temp
data modify entity @s data.rigHash set value 'b9bfdae6aeabc552a496844d4a02fdfa722d8314c3aa5228ed1fe1c077f45dda'
