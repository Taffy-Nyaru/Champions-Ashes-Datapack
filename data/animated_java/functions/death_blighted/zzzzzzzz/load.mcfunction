...
scoreboard players set $aj.death_blighted.variant.death_blight0 aj.id 0
scoreboard players set $aj.death_blighted.variant.death_blight aj.id 1
...
scoreboard players set aj.death_blighted.export_version aj.i -931084496
