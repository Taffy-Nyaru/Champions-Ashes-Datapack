...
execute if score @s aj.gravity_thrust.animation.gravity_thrust.local_anim_time matches 83.. run function animated_java:gravity_thrust/zzzzzzzz/animations/gravity_thrust/end