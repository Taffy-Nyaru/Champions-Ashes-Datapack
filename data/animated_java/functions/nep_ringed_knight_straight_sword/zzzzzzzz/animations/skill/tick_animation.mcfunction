...
execute if score @s aj.nep_ringed_knight_straight_sword.animation.skill.local_anim_time matches 112.. run function animated_java:nep_ringed_knight_straight_sword/zzzzzzzz/animations/skill/end