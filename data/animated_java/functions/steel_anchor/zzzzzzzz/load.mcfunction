...
scoreboard objectives add aj.steel_anchor.animation.skill1.local_anim_time dummy
scoreboard objectives add aj.steel_anchor.animation.throw_anchor.loop_mode dummy
scoreboard objectives add aj.steel_anchor.animation.skill1.loop_mode dummy
scoreboard players set $aj.steel_anchor.animation.throw_anchor aj.id 0
scoreboard players set $aj.steel_anchor.animation.skill1 aj.id 1
scoreboard players set $aj.steel_anchor.variant.default aj.id 0
scoreboard players add .aj.last_id aj.id 0
scoreboard players set $aj.loop_mode.loop aj.i 0
scoreboard players set $aj.loop_mode.once aj.i 1
scoreboard players set $aj.loop_mode.hold aj.i 2
scoreboard players set aj.steel_anchor.export_version aj.i -1224880433
