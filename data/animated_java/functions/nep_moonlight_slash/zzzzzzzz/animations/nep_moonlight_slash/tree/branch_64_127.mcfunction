execute if score @s aj.anim_time matches 64..71 run function animated_java:nep_moonlight_slash/zzzzzzzz/animations/nep_moonlight_slash/tree/branch_64_71
execute if score @s aj.anim_time matches 72..79 run function animated_java:nep_moonlight_slash/zzzzzzzz/animations/nep_moonlight_slash/tree/branch_72_79
...
execute if score @s aj.anim_time matches 120..127 run function animated_java:nep_moonlight_slash/zzzzzzzz/animations/nep_moonlight_slash/tree/branch_120_127