...
execute if score @s aj.nep_moonlight_slash.animation.nep_moonlight_slash.local_anim_time matches 132.. run function animated_java:nep_moonlight_slash/zzzzzzzz/animations/nep_moonlight_slash/end