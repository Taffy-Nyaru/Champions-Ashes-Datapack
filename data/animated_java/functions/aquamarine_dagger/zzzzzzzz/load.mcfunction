...
scoreboard objectives add aj.aquamarine_dagger.animation.aquamarine_heavy_skill.animation.local_anim_time dummy
scoreboard objectives add aj.aquamarine_dagger.animation.aquamarine_skill.local_anim_time dummy
scoreboard objectives add aj.aquamarine_dagger.animation.aquamarine_heavy_skill.animation.loop_mode dummy
scoreboard objectives add aj.aquamarine_dagger.animation.aquamarine_skill.loop_mode dummy
scoreboard players set $aj.aquamarine_dagger.animation.aquamarine_heavy_skill.animation aj.id 0
...
scoreboard players set aj.aquamarine_dagger.export_version aj.i 1899597354
