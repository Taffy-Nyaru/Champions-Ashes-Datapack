...
scoreboard players set @s aj.aquamarine_dagger.animation.aquamarine_heavy_skill.loop_mode 0
...
tag @s add aj.aquamarine_dagger.animation.aquamarine_heavy_skill