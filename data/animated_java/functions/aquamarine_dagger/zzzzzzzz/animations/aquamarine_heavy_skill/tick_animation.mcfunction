...
execute if score @s aj.aquamarine_dagger.animation.aquamarine_heavy_skill.local_anim_time matches 25.. run function animated_java:aquamarine_dagger/zzzzzzzz/animations/aquamarine_heavy_skill/end