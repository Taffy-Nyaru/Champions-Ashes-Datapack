...
execute if score @s aj.dimension_slash.animation.dimension_slash.local_anim_time matches 25.. run function animated_java:dimension_slash/zzzzzzzz/animations/dimension_slash/end