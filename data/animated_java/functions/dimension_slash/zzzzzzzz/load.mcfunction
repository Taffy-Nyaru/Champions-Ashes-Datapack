...
scoreboard objectives add aj.dimension_slash.animation.spinning_slash.local_anim_time dummy
scoreboard objectives add aj.dimension_slash.animation.dimension_slash.loop_mode dummy
scoreboard objectives add aj.dimension_slash.animation.spinning_slash.loop_mode dummy
scoreboard players set $aj.dimension_slash.animation.dimension_slash aj.id 0
scoreboard players set $aj.dimension_slash.animation.spinning_slash aj.id 1
...
scoreboard players set $aj.dimension_slash.variant.spinning_slash1 aj.id 7
scoreboard players add .aj.last_id aj.id 0
scoreboard players set $aj.loop_mode.loop aj.i 0
scoreboard players set $aj.loop_mode.once aj.i 1
scoreboard players set $aj.loop_mode.hold aj.i 2
scoreboard players set aj.dimension_slash.export_version aj.i -1571705438
