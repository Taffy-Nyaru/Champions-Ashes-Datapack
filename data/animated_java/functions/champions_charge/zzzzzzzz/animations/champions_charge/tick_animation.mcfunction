...
execute if score @s aj.champions_charge.animation.champions_charge.local_anim_time matches 45.. run function animated_java:champions_charge/zzzzzzzz/animations/champions_charge/end