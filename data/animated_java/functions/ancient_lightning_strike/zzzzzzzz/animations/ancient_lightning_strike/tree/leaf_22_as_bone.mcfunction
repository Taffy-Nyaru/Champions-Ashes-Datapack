...
execute if entity @s[tag=aj.ancient_lightning_strike.bone.warning_sign] run data modify entity @s {} merge value {transformation:[-0.000013333333333333333f,0f,1.6328623988631376e-21f,0f,0f,0.000013333333333333333f,0f,0f,-1.6328623988631376e-21f,0f,-0.000013333333333333333f,0f,0f,0f,0f,1f],start_interpolation:0}