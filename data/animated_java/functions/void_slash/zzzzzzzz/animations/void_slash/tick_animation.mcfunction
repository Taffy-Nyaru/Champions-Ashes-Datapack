...
execute if score @s aj.void_slash.animation.void_slash.local_anim_time matches 43.. run function animated_java:void_slash/zzzzzzzz/animations/void_slash/end