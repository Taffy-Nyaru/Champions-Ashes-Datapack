...
execute if score @s aj.aquamarine_heavy_skill.animation.aquamarine_heavy_skill.animation.local_anim_time matches 25.. run function animated_java:aquamarine_heavy_skill/zzzzzzzz/animations/aquamarine_heavy_skill.animation/end