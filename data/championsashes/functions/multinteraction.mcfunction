...
execute if entity @e[type=interaction,tag=clicker,scores={lClick=0}] run data modify entity a346a606-7102-4c7f-b48d-14038f3a5e56 Thrower set value [I;1457798924,1924024473,-1820779557,1335992244]
execute if entity @e[type=interaction,tag=clicker,scores={rClick=0}] run data modify entity 2094fd65-93de-4a69-9ea2-a74c7f35bc75 Thrower set value [I;1457798924,1924024473,-1820779557,1335992244]