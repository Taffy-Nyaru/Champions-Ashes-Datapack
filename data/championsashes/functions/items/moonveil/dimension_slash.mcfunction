...
execute as 2094fd65-93de-4a69-9ea2-a74c7f35bc75 on origin if entity @s[predicate=championsashes:using_item/moonveil] at @s unless entity @e[tag=aj.dimension_slash.root,distance=..2] run function championsashes:items/moonveil/skill
