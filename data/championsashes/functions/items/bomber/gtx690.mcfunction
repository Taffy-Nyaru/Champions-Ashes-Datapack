...
execute if score #damage championsashesValue matches 2030.. at @s run summon minecraft:armor_stand ~ ~ ~ {UUID:[I;-2069288940,1479951750,-1848769788,1770971905],Tags:["bomb"],Invulnerable:1b,Invisible:1b,ArmorItems:[{},{},{},{id:netherite_pickaxe,tag:{CustomModelData:1390013},Count:1}],ArmorDropChances:[0f,0f,0f,0f]}
