...
execute as 2094fd65-93de-4a69-9ea2-a74c7f35bc75 on origin if entity @s[tag=!stiff,predicate=championsashes:using_item/irithyll_straight_sword] at @s unless entity @e[tag=aj.sword_dance.root,distance=..2] run function championsashes:items/irithyll_straight_sword/skill
