...
execute if score @s skill_time matches 1..24 as @e[type=!#championsashes:special_entities,distance=..5,tag=!ally,tag=!using_skill] run damage @s 1 championsashes:frostbite by @a[limit=1,sort=nearest,tag=using_skill]
