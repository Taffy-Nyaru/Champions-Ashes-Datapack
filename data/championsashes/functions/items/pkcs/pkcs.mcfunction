...
#Frostbite
execute if entity @s[advancements={championsashes:hurt_entities=true}] as @e[tag=raycast.target,type=!#championsashes:special_entities,limit=1] run tag @s add frost_stiff
