...
execute as @e[tag=aj.favor_incantations.root,limit=1,sort=nearest] run function animated_java:favor_incantations/animations/ancient_lightning_spear/play
tag @s add riding_display
tag @s add favor_incantations_user
tag @s add ancient_lightning_spear_user
