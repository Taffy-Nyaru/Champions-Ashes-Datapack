...
execute store result score @s[tag=!quickstep,tag=!murky_r1_user,tag=!soul_five] gamemode run data get entity @s playerGameType
...
execute if score @s usedCrossbow matches 1.. unless score @s shift matches 1.. at @s unless entity @e[tag=aj.murky_hand_scythe.root,distance=..2] run function championsashes:items/murky/murky_r1
