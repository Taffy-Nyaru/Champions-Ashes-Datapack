...
execute at @e[tag=blast_arrow] if entity @e[tag=!blast_arrow,type=!#championsashes:special_entities,tag=!usedarbalest,distance=..3] run summon creeper ~ ~ ~ {Fuse:0,ExplosionRadius:1,Invulnerable:1b,Tags:["bomb"]}
