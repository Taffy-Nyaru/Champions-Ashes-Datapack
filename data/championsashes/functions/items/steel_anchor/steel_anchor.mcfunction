...
execute as @e[type=!#championsashes:special_entities,predicate=championsashes:hurttime,distance=..7] at @s[tag=!skill3_anchor_hit] positioned ~ ~1.5 ~ facing ^-55 ^-55 ^55 run function championsashes:items/steel_anchor/anchor_hit
execute as @e[type=!#championsashes:special_entities,predicate=championsashes:hurttime,distance=..7] at @s[tag=!skill3_anchor_hit] positioned ~ ~1.5 ~ facing ^-25 ^25 ^-25 run function championsashes:items/steel_anchor/anchor_hit
