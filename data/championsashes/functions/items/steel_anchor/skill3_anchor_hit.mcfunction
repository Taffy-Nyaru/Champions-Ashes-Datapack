...
execute as @e[distance=..10,tag=!bomber,type=!#championsashes:special_entities,type=!player] at @s facing ~ ~ ~ run function championsashes:items/steel_anchor/skill3_anchor_hit_entity
