...
execute as @s[tag=!damaged] run damage @s 0 generic by @e[distance=..8,limit=1,sort=nearest,type=!#championsashes:special_entities,team=!friendly]
execute as @s[tag=!damaged] if entity @e[team=!friendly,limit=1,sort=nearest,type=!#championsashes:special_entities,distance=..8] run tag @s add damaged
execute as @s[tag=damaged] unless entity @e[team=!friendly,limit=1,sort=nearest,type=!#championsashes:special_entities,distance=..9] run tag @s remove damaged
