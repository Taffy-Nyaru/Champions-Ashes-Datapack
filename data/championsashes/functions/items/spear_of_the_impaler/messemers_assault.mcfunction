...
execute as 2094fd65-93de-4a69-9ea2-a74c7f35bc75 on origin if entity @s[predicate=championsashes:using_item/spear_of_the_impaler,tag=!stiff] at @s unless entity @e[tag=aj.messemers_assault.root,distance=..2] run function championsashes:items/spear_of_the_impaler/skill
