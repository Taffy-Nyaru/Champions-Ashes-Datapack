...
execute as a346a606-7102-4c7f-b48d-14038f3a5e56 on origin if entity @s[predicate=championsashes:using_item/moonlight_greatsword] at @s run function championsashes:items/moonlight_greatsword/slash
