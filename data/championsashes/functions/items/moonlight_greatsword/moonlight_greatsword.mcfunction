...
execute if entity @e[type=interaction,distance=..10,tag=clicker,scores={ca.interaction_lClick=1..}] as a346a606-7102-4c7f-b48d-14038f3a5e56 on origin if score @s[tag=!stiff] ca.item.id_selecter_mainhand matches 1032 at @s unless entity @e[tag=moonlight_slash,distance=..20] run function championsashes:items/moonlight_greatsword/slash
