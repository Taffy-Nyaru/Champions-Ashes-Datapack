...
execute unless entity @e[tag=aj.gundyr_skill.root,distance=..1] as 2094fd65-93de-4a69-9ea2-a74c7f35bc75 on origin if entity @s[predicate=championsashes:using_item/gundyr_halberd] run function championsashes:items/gundyr_halberd/skill
