...
execute if entity @s[advancements={championsashes:hurt_entities=true}] at @s as @e[distance=..5,limit=1,type=!#championsashes:special_entities,tag=raycast.target] run function championsashes:items/ringed_knight_straight_sword/attack
