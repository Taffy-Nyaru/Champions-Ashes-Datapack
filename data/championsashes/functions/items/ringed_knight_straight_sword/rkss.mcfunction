...
execute as 2094fd65-93de-4a69-9ea2-a74c7f35bc75 on origin if entity @s[predicate=championsashes:using_item/ringed_knight_straight_sword] run tag @s add cancel
execute as 2094fd65-93de-4a69-9ea2-a74c7f35bc75 on origin if entity @s[predicate=championsashes:using_item/ringed_knight_straight_sword] if score @s shift matches 1.. at @s unless entity @e[tag=aj.rkss_skill.root,distance=..2] run function championsashes:items/ringed_knight_straight_sword/skill
...
execute if entity @s[predicate=championsashes:using_item/black_knight_shield] as 2094fd65-93de-4a69-9ea2-a74c7f35bc75 on origin at @s as @e[limit=1,type=!#championsashes:special_entities,tag=raycast.target] run function championsashes:items/ringed_knight_straight_sword/attack
