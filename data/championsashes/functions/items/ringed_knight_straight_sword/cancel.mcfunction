...
execute if score @s[predicate=championsashes:using_item/ringed_knight_straight_sword] cancel matches 1.. run item modify entity @s weapon.mainhand championsashes:rkss_ignite
...
execute if score @s[predicate=championsashes:using_item/ringed_knight_straight_sword] cancel matches 10.. run item modify entity @s weapon.mainhand championsashes:rkss
