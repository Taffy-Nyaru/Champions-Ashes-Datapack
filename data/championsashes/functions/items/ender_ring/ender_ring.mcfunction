...
execute if entity @s[advancements={championsashes:hurt_entities=true}] store result score @s ender_ring_playerHotbar run data get entity @s SelectedItemSlot
