...
execute as 2094fd65-93de-4a69-9ea2-a74c7f35bc75 on origin if entity @s[tag=!stiff,predicate=championsashes:using_item/lorians_greatsword] if score @s shift matches 1.. at @s unless entity @e[tag=aj.flame_of_lorian.root,distance=..2] run function championsashes:items/lorians_greatsword/skill
