...
execute as @e[type=!#championsashes:special_entities,distance=..5,tag=!splitleaf_skill,tag=!helicopter,team=!friendly] run damage @s 12 player_attack by @a[limit=1,sort=nearest,tag=helicopter]
