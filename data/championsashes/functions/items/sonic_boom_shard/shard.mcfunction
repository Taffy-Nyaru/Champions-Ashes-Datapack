...
execute as a346a606-7102-4c7f-b48d-14038f3a5e56 on origin if entity @s[tag=!stiff] run function championsashes:items/sonic_boom_shard/sonic_boom
...
execute if score @s shift matches 0 as 2094fd65-93de-4a69-9ea2-a74c7f35bc75 on origin if entity @s[tag=!stiff] run function championsashes:items/sonic_boom_shard/tp
execute if score @s shift matches 1.. as 2094fd65-93de-4a69-9ea2-a74c7f35bc75 on origin if entity @s[tag=!stiff] run function championsashes:items/sonic_boom_shard/callback
