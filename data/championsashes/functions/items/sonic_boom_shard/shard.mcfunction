...
execute as @s[advancements={championsashes:hurt_entities=true}] run damage @e[tag=WARDEN,tag=!protected,limit=1] 0 generic by @e[sort=nearest,tag=raycast.target,limit=1]
