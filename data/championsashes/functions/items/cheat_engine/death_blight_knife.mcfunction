...
execute as @e[limit=1,sort=nearest,distance=..3,type=!snowball,type=!#championsashes:special_entities,tag=!death_blighter] run scoreboard players set @s death_blight_Timer 7600