...
execute if entity @e[type=interaction,distance=..10,tag=clicker,scores={ca.interaction_rClick=1..}] if score @s shift matches 1.. as 2094fd65-93de-4a69-9ea2-a74c7f35bc75 on origin if entity @s[tag=!stiff] at @s unless entity @e[tag=aj.rakshasa_great_katana.root,distance=..2] run function championsashes:items/rakshasa_great_katana/weed_cutter
...
execute if entity @e[type=interaction,distance=..10,tag=clicker,scores={ca.interaction_lClick=1..}] unless score @s space matches 1.. unless score @s shift matches 1.. as a346a606-7102-4c7f-b48d-14038f3a5e56 on origin if entity @s[tag=!stiff] at @s unless entity @e[tag=aj.rakshasa_great_katana.root,distance=..2] run function championsashes:items/rakshasa_great_katana/rakshasa_r1
execute if entity @e[type=interaction,distance=..10,tag=clicker,scores={ca.interaction_lClick=1..}] if score @s shift matches 1.. as a346a606-7102-4c7f-b48d-14038f3a5e56 on origin if entity @s[tag=!stiff] at @s unless entity @e[tag=aj.rakshasa_great_katana.root,distance=..2] run function championsashes:items/rakshasa_great_katana/crouch_poke
execute if entity @e[type=interaction,distance=..10,tag=clicker,scores={ca.interaction_lClick=1..}] if score @s space matches 1.. unless score @s shift matches 1.. as a346a606-7102-4c7f-b48d-14038f3a5e56 on origin if entity @s[tag=!stiff] at @s unless entity @e[tag=aj.rakshasa_great_katana.root,distance=..2] run function championsashes:items/rakshasa_great_katana/jump_attack
