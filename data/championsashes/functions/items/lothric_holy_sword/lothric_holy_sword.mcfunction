...
execute if score @s shift matches 1.. as 2094fd65-93de-4a69-9ea2-a74c7f35bc75 on origin if entity @s[predicate=championsashes:using_item/lothric_holy_sword] unless entity @e[tag=lazer_beam,distance=..30] run function championsashes:projectiles/lazer_beam/initialize
