...
execute if score @s usedCrossbow matches 1.. unless score @s shift matches 1.. run function championsashes:items/aquamarine_dagger/skill
execute if score @s usedCrossbow matches 1.. if score @s shift matches 1.. run function championsashes:items/aquamarine_dagger/heavy_skill
