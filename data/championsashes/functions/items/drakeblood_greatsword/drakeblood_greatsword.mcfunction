...
execute if entity @e[type=interaction,distance=..10,tag=clicker,scores={ca.interaction_rClick=1..}] as 2094fd65-93de-4a69-9ea2-a74c7f35bc75 on origin if entity @s[tag=!stiff] unless entity @e[tag=aj.ancient_lightning_strike.root,distance=..10] run tag @s add loop_lightning_bolt
execute if entity @e[type=interaction,distance=..10,tag=clicker,scores={ca.interaction_rClick=1..}] as 2094fd65-93de-4a69-9ea2-a74c7f35bc75 on origin if entity @s[tag=!stiff] unless entity @e[tag=aj.ancient_lightning_strike.root,distance=..10] run tag @s add used_drakeblood_skill
