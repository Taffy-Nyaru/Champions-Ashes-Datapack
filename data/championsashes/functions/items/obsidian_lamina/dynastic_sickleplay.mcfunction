...
execute as 2094fd65-93de-4a69-9ea2-a74c7f35bc75 on origin if entity @s[tag=!stiff,predicate=championsashes:using_item/obsidian_lamina] if score @s shift matches 1.. at @s unless entity @e[tag=aj.dynastic_sickleplay.root,distance=..2] run function championsashes:items/obsidian_lamina/skill
...
execute as a346a606-7102-4c7f-b48d-14038f3a5e56 on origin if entity @s[tag=!stiff,predicate=championsashes:using_item/obsidian_lamina] if score @s shift matches 1.. at @s unless entity @e[tag=aj.dynastic_sickleplay.root,distance=..2] run function championsashes:items/obsidian_lamina/dynastic_throw
