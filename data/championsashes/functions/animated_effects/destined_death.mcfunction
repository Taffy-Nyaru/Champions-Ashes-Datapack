...
execute as @e[distance=..2,type=!#championsashes:special_entities,tag=!destined_death_user] run damage @s 3 championsashes:cheat_engine by @a[limit=1,sort=nearest]
