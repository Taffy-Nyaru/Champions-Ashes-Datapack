...
execute if score #uuid uuidplayer matches 1.. positioned 0 0 0 summon item run function championsashes:bijection/player/uuidplayer
...
#递归循环检测
execute if score #uuid uuidinteraction matches 1.. run function championsashes:bijection/player/uuidinteraction
