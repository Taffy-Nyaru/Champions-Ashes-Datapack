...
execute as @s[type=!player,predicate=championsashes:entity_using_item/murky_hand_scythe] run function championsashes:entities/using_items/murky_hand_scythe
