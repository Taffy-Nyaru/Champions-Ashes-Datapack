...
execute as @s[type=!player,predicate=championsashes:entity_using_item/pontiff_knight_curved_sword] on target run scoreboard players set @s custom_ca.entity.stiff_time 5
