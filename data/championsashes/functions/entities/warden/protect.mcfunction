execute as 0001bf52-001d-4b42-0000-001d0000005c if entity @s[tag=!protected] run damage @s 0 generic by @e[type=!warden,sort=nearest,team=!friendly,type=!#championsashes:special_entities,limit=1]
