summon wither_skeleton ~ ~ ~ {CustomName:'[{"translate":"entity.championsashes.drakeblood_knight","italic":false}]',Health:120,DeathLootTable:"championsashes:entities/drakeblood_knights",CanPickUpLoot:1b,PersistenceRequired:1b,Tags:["drakeblood_knight"],ActiveEffects:[{Id:11,Duration:-1,Amplifier:0,ShowParticles:0b}],Attributes:[{Name:"generic.follow_range",Base:2048f},{Name:"generic.knockback_resistance",Base:0.2f},{Name:"generic.max_health",Base:120f}]}
