execute at @s[tag=!phase2] run summon item_display ^-1 ^1.5 ^ {Tags:["drakeblood_phanalax0"],item:{id:"diamond_sword",Count:1b,tag:{CustomModelData:1390042,Enchantments:[{id:"infinity",lvl:1}]}}}
execute at @s[tag=!phase2] run summon item_display ^ ^2.5 ^ {Tags:["drakeblood_phanalax1"],item:{id:"diamond_sword",Count:1b,tag:{CustomModelData:1390042,Enchantments:[{id:"infinity",lvl:1}]}}}
execute at @s[tag=!phase2] run summon item_display ^1 ^1.5 ^ {Tags:["drakeblood_phanalax2"],item:{id:"diamond_sword",Count:1b,tag:{CustomModelData:1390042,Enchantments:[{id:"infinity",lvl:1}]}}}

execute at @s[tag=phase2] positioned ^-1 ^1.5 ^ run function championsashes:entities/drakeblood_knight/nep_elder/weapon_abilities/void_missle0_summon
execute at @s[tag=phase2] positioned ^ ^2.5 ^ run function championsashes:entities/drakeblood_knight/nep_elder/weapon_abilities/void_missle1_summon
execute at @s[tag=phase2] positioned ^1 ^1.5 ^ run function championsashes:entities/drakeblood_knight/nep_elder/weapon_abilities/void_missle2_summon
