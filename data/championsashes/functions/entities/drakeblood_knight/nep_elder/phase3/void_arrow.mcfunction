...
execute as @e[tag=nep_foe,limit=1,sort=nearest,type=!#championsashes:special_entities,distance=..2.5] run damage @s 16 championsashes:cheat_engine by @e[tag=nep_elder,limit=1,sort=nearest,type=wither_skeleton]
