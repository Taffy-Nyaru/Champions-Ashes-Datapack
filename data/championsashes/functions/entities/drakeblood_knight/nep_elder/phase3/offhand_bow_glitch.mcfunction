execute unless entity @e[tag=aj.nep_offhand_bow_glitch.root,distance=..50,type=item_display] positioned ~ ~0.5 ~ run function animated_java:nep_offhand_bow_glitch/summon
