...
execute if score @s summon.temp matches 600.. unless entity @e[tag=!nep_elder,tag=drakeblood_knight,distance=..50] positioned ^ ^1 ^2 run function championsashes:entities/drakeblood_knight/summon
