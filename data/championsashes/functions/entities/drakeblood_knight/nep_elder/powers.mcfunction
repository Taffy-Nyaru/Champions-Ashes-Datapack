...
attribute @s generic.follow_range base set 300

#Teleporting
execute if entity @e[tag=nep_foe,type=!#championsashes:special_entities,distance=5..] run scoreboard players add teleport_skill.temp championsashes_Timer 1
execute if score teleport_skill.temp championsashes_Timer matches 150.. at @e[tag=nep_foe] run teleport @s ~-1 ~1 ~-1
execute if score teleport_skill.temp championsashes_Timer matches 150.. run fill ~-1 ~-1 ~-1 ~1 ~1 ~1 air replace #championsashes:destroyable_blocks
...
execute if data storage generic:main {NepSelectedItem:{tag:{id:"championsashes:black_knight_greataxe"}}} at @e[tag=nep_foe,type=!#championsashes:special_entities,predicate=championsashes:hurttime] run summon lightning_bolt ~ ~ ~ {Tags:["Thunder"]}

#Drakeblood Greatsword
scoreboard players add #nep_use_lightning_strike_skill championsashes_Timer 1
execute if score #nep_use_lightning_strike_skill championsashes_Timer matches 256.. if entity @s[tag=nep_drakeblood_greatsword] run function championsashes:entities/drakeblood_knight/nep_elder/weapon_abilities/drakeblood_greatsword_abilities
...
execute if entity @e[type=!player,tag=loop_start] at @e[tag=nep_foe,type=!#championsashes:special_entities,predicate=championsashes:hurttime] positioned ~ ~6 ~ if score @s arrow_rain.temp matches 1.. run function championsashes:items/dragonslayer_greatbow/loop_summon_arrow
...
function championsashes:entities/drakeblood_knight/nep_elder/clean_negative_effects
