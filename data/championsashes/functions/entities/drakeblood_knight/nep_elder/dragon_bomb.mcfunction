...
execute if entity @e[tag=foe,gamemode=!creative,gamemode=!spectator,distance=..10] facing entity @e[tag=phase2,limit=1,sort=nearest] eyes positioned ^-1 ^ ^ rotated as @s positioned ^ ^ ^ facing entity @e[tag=foe,limit=1,sort=nearest] eyes positioned as @s run tp @s ^ ^-0.25 ^0.5 ~ ~
