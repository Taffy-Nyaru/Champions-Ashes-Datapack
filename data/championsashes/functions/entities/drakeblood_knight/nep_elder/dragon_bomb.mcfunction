...
execute if entity @e[tag=nep_foe,distance=..10] facing entity @e[tag=phase2,limit=1,sort=nearest] eyes positioned ^-1 ^ ^ rotated as @s positioned ^ ^ ^ facing entity @e[tag=nep_foe,limit=1,sort=nearest] eyes positioned as @s run tp @s ^ ^ ^0.5 ~ ~
