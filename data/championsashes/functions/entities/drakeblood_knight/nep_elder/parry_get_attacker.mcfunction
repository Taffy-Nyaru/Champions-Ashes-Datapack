execute as 25ff7e34-a8a7-4cd2-9bbc-c7a3d4ccc3cd unless entity @s[distance=..5] run summon interaction ~ ~ ~ {UUID:[I;637500980,-1465430830,-1682126941,-724778035],response:1b,width:3,height:3}
