...
execute unless block ^ ^2 ^1 air run scoreboard players add @s nep_block_destroy_timer 1
...
execute if block ^ ^2 ^1 air run scoreboard players set @s nep_block_destroy_timer 0