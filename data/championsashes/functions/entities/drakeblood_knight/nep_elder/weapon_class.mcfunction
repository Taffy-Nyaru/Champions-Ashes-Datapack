...
execute if score change_weapon_inventory math_output matches 301..400 run loot replace entity @s weapon.mainhand loot championsashes:armor/tools/drakeblood_greatsword
