...
execute if score #elder_parrying_time championsashes_Timer matches 1 unless entity @e[tag=parry_shield,distance=..5] run summon item_display ^ ^1.5 ^1 {Tags:["parry_shield"],item:{id:"shield",Count:1b,tag:{CustomModelData:1390050,Enchantments:[{id:"infinity",lvl:1}]}}}
