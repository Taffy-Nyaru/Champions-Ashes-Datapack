...
execute as 942429eb-9233-4105-a36e-8fec8f4ce862 on origin if entity @s[tag=!aj.nep_void_missle.root] at @s if entity @e[tag=nep_foe,type=!#championsashes:special_entities,distance=..2] run function championsashes:entities/drakeblood_knight/phanalax_kill
execute as 5100af9e-e223-424b-bfd7-6ce806d33213 on origin if entity @s[tag=!aj.nep_void_missle.root] at @s if entity @e[tag=nep_foe,type=!#championsashes:special_entities,distance=..2] run function championsashes:entities/drakeblood_knight/phanalax_kill
execute as 9bf0d198-816f-4084-8c37-27d0f958bba1 on origin if entity @s[tag=!aj.nep_void_missle.root] at @s if entity @e[tag=nep_foe,type=!#championsashes:special_entities,distance=..2] run function championsashes:entities/drakeblood_knight/phanalax_kill

execute if entity @s[tag=!phase2,tag=!phase3] if entity @e[tag=nep_foe,type=!#championsashes:special_entities, distance=..8] as 942429eb-9233-4105-a36e-8fec8f4ce862 on origin at @s facing entity @e[limit=1,sort=nearest,tag=entity_with_drakeblood_phanalax] feet facing entity @e[tag=nep_foe,type=!#championsashes:special_entities,limit=1,sort=nearest] feet positioned as @s run tp @s ^ ^ ^0.75 ~-90 ~-90
execute if entity @s[tag=!phase2,tag=!phase3] unless entity @e[tag=nep_foe,type=!#championsashes:special_entities, distance=..8] as 942429eb-9233-4105-a36e-8fec8f4ce862 on origin at @s rotated as @e[limit=1,sort=nearest,tag=entity_with_drakeblood_phanalax] positioned ^ ^ ^ run tp @s ~ ~ ~ ~-90 ~-90
execute unless entity @e[tag=nep_foe,type=!#championsashes:special_entities, distance=..8] as 942429eb-9233-4105-a36e-8fec8f4ce862 on origin unless entity @s[tag=aj.nep_void_missle.root] run tp @s ^-1 ^1.5 ^

execute if entity @s[tag=!phase2,tag=!phase3] if entity @e[tag=nep_foe,type=!#championsashes:special_entities, distance=..8] as 5100af9e-e223-424b-bfd7-6ce806d33213 on origin at @s facing entity @e[limit=1,sort=nearest,tag=entity_with_drakeblood_phanalax] feet facing entity @e[tag=nep_foe,type=!#championsashes:special_entities,limit=1,sort=nearest] feet positioned as @s run tp @s ^ ^ ^0.75 ~-90 ~-90
execute if entity @s[tag=!phase2,tag=!phase3] unless entity @e[tag=nep_foe,type=!#championsashes:special_entities, distance=..8] as 5100af9e-e223-424b-bfd7-6ce806d33213 on origin at @s rotated as @e[limit=1,sort=nearest,tag=entity_with_drakeblood_phanalax] positioned ^ ^ ^ run tp @s ~ ~ ~ ~-90 ~-90
execute unless entity @e[tag=nep_foe,type=!#championsashes:special_entities, distance=..8] as 5100af9e-e223-424b-bfd7-6ce806d33213 on origin unless entity @s[tag=aj.nep_void_missle.root] run tp @s ^ ^2.5 ^

execute if entity @s[tag=!phase2,tag=!phase3] if entity @e[tag=nep_foe,type=!#championsashes:special_entities, distance=..8] as 9bf0d198-816f-4084-8c37-27d0f958bba1 on origin at @s facing entity @e[limit=1,sort=nearest,tag=entity_with_drakeblood_phanalax] feet facing entity @e[tag=nep_foe,type=!#championsashes:special_entities,limit=1,sort=nearest] feet positioned as @s run tp @s ^ ^ ^0.75 ~-90 ~-90
execute if entity @s[tag=!phase2,tag=!phase3] unless entity @e[tag=nep_foe,type=!#championsashes:special_entities, distance=..8] as 9bf0d198-816f-4084-8c37-27d0f958bba1 on origin at @s rotated as @e[limit=1,sort=nearest,tag=entity_with_drakeblood_phanalax] positioned ^ ^ ^ run tp @s ~ ~ ~ ~-90 ~-90
execute unless entity @e[tag=nep_foe,type=!#championsashes:special_entities, distance=..8] as 9bf0d198-816f-4084-8c37-27d0f958bba1 on origin unless entity @s[tag=aj.nep_void_missle.root] run tp @s ^1 ^1.5 ^