...
execute as 942429eb-9233-4105-a36e-8fec8f4ce862 on origin at @s[tag=!aj.nep_void_missle.root] if entity @e[tag=nep_foe,type=!#championsashes:special_entities,distance=..4] run function championsashes:entities/drakeblood_knight/phanalax_kill
execute as 5100af9e-e223-424b-bfd7-6ce806d33213 on origin at @s[tag=!aj.nep_void_missle.root] if entity @e[tag=nep_foe,type=!#championsashes:special_entities,distance=..4] run function championsashes:entities/drakeblood_knight/phanalax_kill
execute as 9bf0d198-816f-4084-8c37-27d0f958bba1 on origin at @s[tag=!aj.nep_void_missle.root] if entity @e[tag=nep_foe,type=!#championsashes:special_entities,distance=..4] run function championsashes:entities/drakeblood_knight/phanalax_kill
...
#execute as @e[type=item_display,tag=aj.nep_void_missle.root,distance=10..] run function animated_java:nep_void_missle/remove/this