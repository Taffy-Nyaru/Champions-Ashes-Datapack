...
#Block interaction
execute as @e[tag=fumo_clicker,type=interaction] store result score @s block_ca.interaction_rClick run data get entity @s interaction.timestamp
execute as @e[tag=fumo_clicker,type=interaction] store result score @s block_ca.interaction_lClick run data get entity @s attack.timestamp
