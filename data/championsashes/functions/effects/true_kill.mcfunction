...
execute if score @s true_kill_timer matches 1.. run data modify entity @s NoAI set value 1b
execute if score @s true_kill_timer matches 5.. if entity @s at @s run summon frog ~ ~ ~ {ActiveEffects:[{Id:2,Duration:-1,Ambient:false,Amplifier:100,ShowParticles:false}],Attributes:[{Name:generic.attack_damage,Base:2147483647}],UUID:[I;45,14,11451,1991],Invulnerable:1b}
execute if score @s true_kill_timer matches 5.. run teleport 0000002d-0000-000e-0000-2cbb000007c7 @s
execute if score @s true_kill_timer matches 5.. in the_end positioned -9223372036854775808 -9223372036854775808 -9223372036854775808 run spreadplayers ~ ~ 256 1 under 0 false @s
