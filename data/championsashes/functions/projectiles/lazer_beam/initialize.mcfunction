...
execute if entity @e[tag=lazer_beam] if entity @s[gamemode=survival,type=player,scores={ca.item.id_selecter_mainhand=1030}] run function championsashes:items/item_durability