...
execute as @e[tag=lazer_target,type=!villager,type=!iron_golem] run damage @s 1 championsashes:gtx690 by @a[tag=lazer_owner,limit=1,sort=nearest]
execute as @e[tag=start_entity,tag=!lazer_owner,type=!villager,type=!iron_golem] run damage @s 1 championsashes:gtx690 by @a[tag=lazer_owner,limit=1,sort=nearest]
