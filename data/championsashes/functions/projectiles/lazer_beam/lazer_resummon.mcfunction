...
execute as @e[limit=1,sort=nearest,type=!#championsashes:special_entities,tag=!lazer_node,distance=..20] at @s run function championsashes:projectiles/lazer_beam/initialize
