...
#Explosion
execute if entity @e[type=!#championsashes:special_entities,tag=!shot_gravity_orb,distance=..3] run function championsashes:projectiles/gravity_orb_projectile/explosion
