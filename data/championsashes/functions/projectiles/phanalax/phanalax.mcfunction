...
execute as 942429eb-9233-4105-a36e-8fec8f4ce862 on origin at @s if entity @e[team=!friendly,distance=..3.5] run function championsashes:projectiles/phanalax/kill
execute as 5100af9e-e223-424b-bfd7-6ce806d33213 on origin at @s if entity @e[team=!friendly,distance=..3.5] run function championsashes:projectiles/phanalax/kill
execute as 9bf0d198-816f-4084-8c37-27d0f958bba1 on origin at @s if entity @e[team=!friendly,distance=..3.5] run function championsashes:projectiles/phanalax/kill
