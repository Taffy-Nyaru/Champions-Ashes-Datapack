...
#Explosion
execute as @e[type=!#championsashes:special_entities,type=!lightning_bolt,tag=!shot] at @e[tag=head_projectile] if entity @s[distance=..3.5] run summon creeper ~ ~ ~ {Invulnerable:1b,Tags:["bomb"],Fuse:0,powered:1b}
