...
data modify entity @s item.tag.CustomModelData set value 1440007
...
execute as 00041459-ffff-330c-ffff-b82800017722 on origin run effect give @s resistance 3 10 true