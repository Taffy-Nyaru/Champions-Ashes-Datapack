...
execute if entity @e[type=interaction,distance=..10,tag=clicker,scores={ca.interaction_rClick=1..}] at @s positioned 0 0 0 as e370442d-c2f2-4495-9ceb-50b614118d0f run function championsashes:blocks/crying_waystone/teleport
