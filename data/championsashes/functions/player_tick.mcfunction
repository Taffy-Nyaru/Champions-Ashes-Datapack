...
execute if data storage championsashes:player_data {SelectedItem:{tag:{id:"championsashes:ringed_knight_straight_sword"}}} run function championsashes:items/ringed_knight_straight_sword/rkss
execute as @s[tag=cancel] run function championsashes:items/ringed_knight_straight_sword/cancel
execute as @e[tag=aj.rkss_skill.root] at @s run function championsashes:items/ringed_knight_straight_sword/animation
